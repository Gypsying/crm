...
class UserInfo(models.Model):
    ...
    员工表
    """
    auth = models.OneToOneField(verbose_name='用户权限', to=rbac_models.UserInfo, null=True, blank=True)
...
class ClassList(models.Model):
    ...
    description = models.CharField(verbose_name='说明', max_length=256, blank=True, null=True, )
